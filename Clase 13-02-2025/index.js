...
function mostrarMensaje(){
    console.log('Estoy aprendiendo funciones de JavaScript! :D');
}
...
saludoDiferente('Jessica', 'Martínez', 20, 'Dibujar')
...
const estudiantes = [
    {nombre: 'Jessica', notas: [80, 90, 100]},
    {nombre: 'Oscar', notas: [90, 91, 75]},
    {nombre: 'Laura', notas: [70, 90, 100]}
]
